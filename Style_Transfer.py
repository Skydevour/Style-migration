...
style_img = image_loader("images/girl.jpg")
content_img = image_loader("images/boy.jpg")
...
def get_input_optimizer(input_img):
    # this line to show that input is a parameter that requires a gradient 输入图片是模型参数
